...
fixations_df = pd.read_csv("/Users/scottliu/Desktop/1+2/easy_step_test/fixations.csv")
...
aoi_filtered_df.to_csv("/Users/scottliu/Desktop/1+2_aoi/easy_aoi.csv", index=False)

print("筛选完成，结果保存在 easy_aoi.csv")
