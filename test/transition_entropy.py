...
aoi_list = ["Guide", "OR", "Progbars"]

"""easy"""
file_path = "/Users/scottliu/Desktop/pr Processed Data AOI/E1/E1_P1_e/aoi_fixations.csv"
df = pd.read_csv(file_path)
df = df.sort_values(by="fixation id", ascending=True, ignore_index=True)
