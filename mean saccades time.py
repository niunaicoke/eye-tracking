...
def save_results_to_csv(filename="saccades_duration.csv"):
...
def mean_saccades (minute=1, sec=1, label="x", data=""):
    ...
    result = round(duration / num_saccades, 3)
    print(f"The mean saccades for {label} is {result} ms per saccade")
